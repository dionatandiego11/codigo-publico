  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[260px_1fr_360px]">
      ...
      <article className="glass-panel p-6 rounded-[20px]">
        ...
        <div className="mt-5 rounded-xl bg-[var(--color-git-bg2)] border border-[var(--color-git-border)] p-4 text-sm leading-7 text-[var(--color-git-text)]">
          {selectedArticle.content}
        </div>
        <div className="mt-4 rounded-xl bg-[rgba(52,211,153,0.05)] border border-[rgba(52,211,153,0.2)] p-4 shadow-[0_0_15px_rgba(52,211,153,0.05)]">
