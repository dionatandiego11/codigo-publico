    ...
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white shadow-sm">
      ...
      <div className="flex h-12 w-full items-center justify-between px-4 bg-slate-900 text-white text-xs font-medium shrink-0">
        ...
        <div className="flex items-center space-x-3 text-[11px] font-mono text-slate-300">
          ...
          <span className="border-l border-slate-700 pl-3 hidden md:inline">UTC: 2026-06-10 12:10</span>
        </div>
      </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <div className="hidden xl:block text-left text-[11px]">
              <p className="font-semibold text-slate-800 leading-tight">Dionatan Santos</p>
              <p className="text-[9px] text-emerald-600 font-mono">Campo Grande</p>
            </div>
          </div>
      ...
      <div className="border-t border-slate-200 bg-slate-50 px-4 py-2.5 hidden sm:block">
        <div className="mx-auto max-w-7xl flex items-center justify-between space-x-2">
          ...
          <div className="flex-1 flex items-center space-x-2 rounded-md border border-slate-200 bg-white px-3 py-1 text-xs text-slate-500 font-mono shadow-inner">
            ...
            />
            <span className="px-1.5 py-0.5 rounded bg-amber-100 text-amber-800 ml-auto text-[9px] font-bold tracking-wide uppercase select-none">
              API-MOCK (GO LAYOUT READY)
            </span>
          </div>
